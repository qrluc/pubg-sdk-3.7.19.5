...
void UCountDownWidget_C::GetTslGameState(class ATslGameState** GameState)
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(175079);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(175075);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(175072);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(175066);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(175043);
