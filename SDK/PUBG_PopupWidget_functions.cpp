...
void UPopupWidget_C::OnGamepadButtonVisibilityPrepass(class UWidget* BoundWidget)
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(163966);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(163961);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(163939);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(163936);
