...
void UItem_Boost_PainKiller_C::BoostGaugeUp()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(129471);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(129465);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(129457);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(129453);
