...
void UItem_Boost_EnergyDrink_C::BoostGaugeUp()
{
	...
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(113402);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(113396);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(113388);
...
{
	static UFunction* fn = nullptr; 
	if (!fn) fn = UObject::GetObjectCasted<UFunction>(113384);
